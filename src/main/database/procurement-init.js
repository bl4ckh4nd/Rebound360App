...
exports.defaultProcurementWorkflow = void 0;
exports.initializeProcurementWorkflow = initializeProcurementWorkflow;
var uuid_1 = require("uuid");
exports.defaultProcurementWorkflow = {
...
function initializeProcurementWorkflow(createWorkflow) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, createWorkflow(exports.defaultProcurementWorkflow)];
                case 1:
                    _a.sent();
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('Error initializing procurement workflow:', error_1);
                    return [3 /*break*/, 3];
